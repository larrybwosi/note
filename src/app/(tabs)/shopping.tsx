...
const ShoppingBudgetPlanner = () => {
	...
	const { getActiveList, getAllShoppingLists, removeItemFromList } = useShoppingStore()
	...
	// Budget calculations
	const totalSpent = shoppingItems?.reduce((sum, item) => sum + item.price * item.quantity, 0) || 0;

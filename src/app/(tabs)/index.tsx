...
export default function BankingApp(): React.ReactElement {
  return (
		<Animated.View layout={LinearTransition.springify()} className="flex-1 bg-gray-50 dark:bg-gray-900">
			...
			<View className=" flex justify-between flex-row px-4 py-4 bg-white dark:bg-gray-800 items-center">
				<View className="px-4 pb-2 mt-4">
					<Text className="text-2xl font-rbold text-gray-800 mt-2 dark:text-white">Hello Larry 👋</Text>

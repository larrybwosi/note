...
import { BudgetRuleType, EXPENSE_CATEGORIES, ExpenseCategoryId, INCOME_CATEGORIES, IncomeCategoryId } from 'src/store/finance/types';
...
const addNewCategory = useCallback(() => {
      ...
      {['INCOME', 'EXPENSE'].map((type) => (
        <Pressable
          ...
          style={{
            ...
            paddingVertical: 12,
            borderRadius: 8,
            backgroundColor: activeTab === type ? isDarkMode? '#E2E8F0': '#FFFFFF' : isDarkMode ? '#FFFFFF' : '#E2E8F0',
  ...
  const renderStep = () => {
    switch (step) {
          ...
          >
            ...
            >
              <View className="space-y-6">
                <View>
                  <Text className="text-lg font-rmedium text-gray-700 mb-2 mt-2 dark:text-white">Monthly Income After Taxes</Text>
            ...
            >
              <Text className="text-base font-aregular text-gray-700 dark:text-white">Your Monthly Income:</Text>
      ...
      case 2:
        return (
          <BudgetRuleSelector rules={rules}/>
        );

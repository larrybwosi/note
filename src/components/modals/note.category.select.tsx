...
const NoteCategorySelect: React.FC<EnhancedNoteCategorySelectProps> = ({
  ...
  return (
    ...
    >
      <Animated.View 
        className="bg-white dark:bg-gray-800 p-2 pt-4"
      ...
      >
        ...
        <Text className="text-gray-600 font-aregular dark:text-gray-400 mb-4">
        ...
        <View className="max-h-96">
          {categories.map((category) => (
            <TouchableOpacity
              ...
              className={`flex-row items-center p-2 rounded-xl mb-3 ${
            ...
            >
              ...
              <View className="ml-4 flex-1">
                <Text className={`text-md mt-2 font-rbold ${
                  selectedCategoryId === category.id
        ...
        <TouchableOpacity
          onPress={onClose}
          className="mt-6 bg-blue-400 dark:bg-gray-700 p-4 rounded-xl items-center"
        >
          <Text className="text-white font-rbold">Cancel</Text>
        </TouchableOpacity>
      </Animated.View>
    </Animated.View>
  );

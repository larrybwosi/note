...
interface BudgetRuleGroups {
	...
	categories: string[];
	color: string;
	remainingBalance?: number; // Added for tracking remaining balance
}

type BudgetPeriodType = 'weekly' | 'monthly' | 'yearly';
type BudgetRuleType = 'groups' | 'categories';
type BudgetStatus = 'active' | 'inactive' | 'completed';
				...
				<View className="flex-1 bg-black/50 justify-end">
					<View className="bg-white rounded-t-3xl p-6 shadow-lg">
						...
						>
							...
							<Text className="text-base font-semibold text-white ml-2">Add to Shopping List</Text>
						</TouchableOpacity>

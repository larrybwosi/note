		...
		>
			...
			>
				<View className="flex-row items-center">
					...
					<View>
						<Text className="font-medium text-gray-800 dark:text-white">{category.name}</Text>
						<Text className="text-xs text-gray-500 dark:text-gray-400">{items.length} items</Text>
					</View>
				</View>
				<View className="flex-row items-center">
					<Text className="font-bold text-gray-800 dark:text-white mr-2">${total.toFixed(2)}</Text>

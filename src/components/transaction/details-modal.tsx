...
const TransactionDetailsModal: React.FC<TransactionDetailsModalProps> = ({
	...
	const renderCategoryOptions = () => {
		...
		const filteredCategories = categories.filter(
			(cat) =>
				cat.type === editedTransaction?.type || (cat.type === 'income')
		);
		return (
          ...
          <View className="flex-1 justify-end">
            ...
            <View className="bg-white dark:bg-gray-800 rounded-t-3xl max-h-5/6">
              ...
              <ScrollView className="px-6 pb-8">
                ...
                <View
                  className={`mt-4 p-6 rounded-2xl ${getBackgroundColor(
                    isEditing ? editedTransaction.type : transaction.type
                  )}`}
                >
                  {isEditing ? (
                    <>
                      ...
                      <View className="flex-row items-center justify-between">
                        <TextInput
                          ...
                          className={`text-3xl font-rbold ${getTypeColor(
                        ...
                        >
                          <Text
                            className={getTypeColor(editedTransaction.type)}
                          >
                      ...
                      <View className="flex-row items-center justify-between">
                        <View className="flex-row items-center">
                          ...
                          <Text className="ml-3 text-base text-gray-700 dark:text-gray-300">
                            {renderFrequencyText(
                              isEditing
                                ? editedTransaction.recurring?.frequency ||
                                    "monthly"
                  ...
                  {isEditing ? (
                    ...
                    <View className="flex flex-row justify-between">
                      <TouchableOpacity
                        ...
                        className="bg-blue-500 p-4 rounded-xl flex-row items-center gap-2"
                      >
                        <Text className="text-white font-rmedium text-base">
                          Edit Transaction
                        </Text>
                      ...
                      <TouchableOpacity
                        ...
                        className="border border-red-500 p-4 rounded-xl flex-row items-center"
                      >
                        <Text className="text-rose-500 font-rmedium text-base">
                          Delete Transaction
                        </Text>
